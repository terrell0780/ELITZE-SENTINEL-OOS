...
export default function LindyPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#09090B]">
      <header className="h-16 border-b border-[#27272A] flex items-center px-6 shrink-0 justify-between bg-[#09090B]">
        <div>
          <h1 className="text-lg font-semibold text-white">Lindy AI Autonomous Agents</h1>
          <p className="text-[10px] font-semibold text-[#71717A] uppercase tracking-widest mt-0.5">Automated Workflows & Delegation</p>
        </div>
        <button className="px-4 py-2 bg-[#D92A2A] hover:bg-[#D92A2A]/90 text-white text-xs font-semibold rounded-lg transition-colors flex items-center gap-2">
        ...
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-4 gap-4">
            {[
              ...
              <div key={stat.label} className="bg-[#111113] border border-[#27272A] rounded-xl p-5 flex flex-col">
                <span className="text-[10px] font-semibold text-[#71717A] uppercase tracking-widest">{stat.label}</span>
          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1 space-y-4">
              <h2 className="text-[10px] font-semibold text-[#71717A] uppercase tracking-widest pl-1">Deployed Agents</h2>
              
              <div className="grid grid-cols-1 gap-4">
                {agents.map(agent => (
                  <div key={agent.id} className="bg-[#111113] border border-[#27272A] hover:border-[#D92A2A]/40 rounded-xl p-5 flex items-center justify-between cursor-pointer transition-colors group">
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-lg bg-[#09090B] border border-[#27272A] flex items-center justify-center group-hover:border-[#D92A2A]/50 group-hover:text-[#D92A2A] transition-colors text-[#A1A1AA]">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <span className="text-xs text-[#A1A1AA]">{agent.runs} runs</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#09090B] border border-[#27272A]">
                        <span className={`w-1.5 h-1.5 rounded-full ${
                          agent.status === 'active' ? 'bg-[#D92A2A]' : 'bg-[#71717A]'
                        }`}></span>
            ...
            <div className="w-80 space-y-4">
              <h2 className="text-[10px] font-semibold text-[#71717A] uppercase tracking-widest pl-1">Live Activity</h2>
              <div className="bg-[#111113] border border-[#27272A] rounded-xl p-5 flex flex-col gap-4">
                {[
                  ...
                  <div key={i} className="flex gap-3">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#D92A2A] mt-1.5 shrink-0"></div>
                    <div className="flex flex-col">
                      <span className="text-xs text-white font-medium">{log.agent}</span>
                      <span className="text-xs text-[#A1A1AA]">{log.action}</span>
