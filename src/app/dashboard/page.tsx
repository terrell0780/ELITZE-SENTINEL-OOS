    ...
    <div className="min-h-screen bg-[#0B0F19] text-[#F8FAFC] flex flex-col font-sans select-none relative overflow-hidden">
      ...
      <header className="h-16 border-b border-[#1E293B] bg-[#0B0F19]/80 backdrop-blur-md flex items-center justify-between px-8 max-w-7xl w-full mx-auto relative z-10 shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="text-xs font-semibold text-[#94A3B8] hover:text-white px-3 py-1.5 rounded-lg border border-[#1E293B] hover:bg-[#1E293B] transition-colors"
          >
            Sign out
          </button>
        </div>
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 md:p-8 space-y-8 relative z-10 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-[#111827] border border-[#1E293B] rounded-2xl p-6 shadow-lg space-y-6">
            ...
            <div className="h-64 w-full bg-[#0B0F19] rounded-xl border border-[#1E293B] p-4 flex flex-col justify-between relative overflow-hidden">
              
              {/* Subtle Grid Lines */}
              <div className="absolute inset-0 grid grid-rows-4 divide-y divide-[#1E293B]/40 pointer-events-none" />
            ...
            <div className="grid grid-cols-3 gap-4 pt-2">
              <div className="p-3 bg-[#0B0F19] border border-[#1E293B] rounded-xl">
          ...
          <div className="bg-[#111827] border border-[#1E293B] rounded-2xl p-6 shadow-lg space-y-6 flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-[#0B0F19] border border-[#1E293B]/80 text-xs">
                    <div>
            ...
            <button
              ...
              className="w-full py-2.5 rounded-xl border border-[#1E293B] bg-[#0B0F19] hover:bg-[#1E293B] text-white text-xs font-semibold transition-all mt-4"
            >
