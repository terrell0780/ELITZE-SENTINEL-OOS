    ...
    <div className="h-full bg-[#09090B] overflow-y-auto flex flex-col">
      ...
      <div className="p-6 flex-1">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="bg-[#111113] border border-[#27272A] rounded-xl p-6 text-center space-y-2">
            <p className="text-sm text-[#A1A1AA]">System operational — connected to brain API</p>
            <p className="text-xs text-[#A1A1AA]">Active collections: {Object.keys(dbStats).join(", ") || "none"}</p>
          </div>
        </div>
      </div>
    </div>
